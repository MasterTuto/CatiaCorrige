...
class VisualGCode():
    ...
    def leia(self, codigo):
        ...
        tipo = tiposDeDadosExistentesDict[self.tiposDasVariaveis[nomeVariavel]]
    ...
    def __tratarCondicao(self, condicao):
        ...
        condicoesDict = {
            'MOD': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+'%'+i[2]),
            '=': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+'=='+i[2]),
            '<>': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+'!='+i[2]),
            'e': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+' and '+i[2]),
            'ou': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+' or '+i[2]),
            'não': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+' not '+i[2]),
            'nao': lambda: condicao.replace(i[0]+i[1]+i[2], i[0]+' not '+i[2])
        }

        for i in todos:
            condicao = condicoesDict[i[1]]()
...
def main():
    ...
    codigo_visualg = VisualGCode('''var
  n1, n2, o: inteiro
  r: real
...
inicio
  ...
  escolha o
    ...
    caso 2
      r<-n1-n2
    outrocaso
      escreva("sua mula nao temos essa opção! ")
      r<-0
    fimescolha
